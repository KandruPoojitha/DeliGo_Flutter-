          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<DatabaseEvent> snapshot) {
                ...
                List<MapEntry<dynamic, dynamic>> chatMessages = messages.entries
                    .where((entry) => 
                        (entry.value['senderId'] == widget.userId || 
                         entry.value['senderId'] == _currentUser?.uid) &&
                        (entry.value['senderType'] == widget.userType || 
                         entry.value['senderType'] == 'admin'))
                    .toList();
